...
If you are looking for a pre-built binary, try the [releases page](https://github.com/ghr1234/SnailMail/releases/).
...
Open Issues As of Version 1.94:
...
* Bug fix when using Return Address drop-down.
